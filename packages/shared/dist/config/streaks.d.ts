...
export declare const STREAK_QUALIFYING_CONFIDENCE: ConfidenceValue[];
export declare const STREAK_MECHANICS_ENABLED = true;
export declare const STREAK_REWARDS: {
    /** At streak >= 2, the next successful high-confidence answer also gets
     * this flat bonus on top of normal confidence scoring. */
    bonusAtStreak: number;
    bonusPoints: number;
