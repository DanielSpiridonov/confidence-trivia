...
const styles = StyleSheet.create({
  ...
  card: { width: "48.8%", minHeight: 98, flexDirection: "row", padding: 11, borderRadius: 12, backgroundColor: "rgba(31, 26, 51, 0.92)", borderWidth: 1, borderColor: "rgba(124, 92, 255, 0.35)" },
